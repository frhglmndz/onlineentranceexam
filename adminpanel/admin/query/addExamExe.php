<?php 
 ...
 else
 {
	...
	$insExam = $conn->query("INSERT INTO exam_tbl(cou_id,ex_title,ex_time_limit,ex_questlimit_display,ex_description) VALUES('','$examTitle','$timeLimit','$examQuestDipLimit','$examDesc') ");
	if($insExam)
	{
